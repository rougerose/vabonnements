...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'cfg_relances_echeances_label' => "Relance des abonnements avant leur échéance",
	'cfg_relances_echeances_explication' => "Pour les abonnements à échéance : saisir les seuils de relance par mail, en nombre de jours, séparés par des virgules (Ex: -30, -15, -10 pour relancer à 30 jours puis 15 jours, puis 10 jours avant la date d'échéance de l'abonnement).",
	'cfg_relances_tiers_label' => "Relance des abonnements offerts",
	'cfg_relances_tiers_explication' => "Pour les abonnements offerts et qui n'ont pas été activés après le premier mail d'invitation : saisir les seuils de relance par mail, en nombre de jours, séparés par des virgules (Ex: 10, 15, 30 pour relancer à 10 jours puis 15 jours, puis 30 jours après la date d'envoi du premier mail).",
